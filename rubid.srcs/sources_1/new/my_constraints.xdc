...
## 5. LEDs (16-bit binary temp display)
...
connect_debug_port u_ila_0/probe0 [get_nets [list {scramble_move[0]} {scramble_move[1]} {scramble_move[2]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 16 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {temp_raw[0]} {temp_raw[1]} {temp_raw[2]} {temp_raw[3]} {temp_raw[4]} {temp_raw[5]} {temp_raw[6]} {temp_raw[7]} {temp_raw[8]} {temp_raw[9]} {temp_raw[10]} {temp_raw[11]} {temp_raw[12]} {temp_raw[13]} {temp_raw[14]} {temp_raw[15]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list BTNC_IBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list scramble_done_flag]]
